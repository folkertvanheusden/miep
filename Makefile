...
CXXFLAGS+=-O3 -pedantic -Wall -Wno-unused-variable -Wno-long-long -std=c++17 -DVERSION=\"$(VERSION)\" $(DEBUG_FLAGS)
...
check:
	cppcheck -v --enable=all --std=c++17 --inconclusive -I. . 2> err.txt
